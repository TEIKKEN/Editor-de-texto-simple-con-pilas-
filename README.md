...
1) Pila principal: almacena las acciones realizadas por el usuario.
2) Pila secundaria: almacena las acciones deshechas para permitir rehacerlas.
...
Las operaciones fundamentales implementadas fueron:
...
Abrir el proyecto en cualquier IDE compatible con Java.
...
4. Mostrar texto actual
   Ultima linea escrita: Aprendiendo pilas en Java
2. Deshacer
